...
class DonateController extends Controller
{
    ...
    public function store(Request $request)
   {
     ...
     $checkSum = $data_for_request['checkSum'];
       return view( 'donate.paytm-merchant-form', compact( 'paytm_txn_url', 'paramList', 'checkSum' ) );
   ...
   */
      ...
      public function paytmCallback( Request $request )  {
          ...
          if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
              ...
              $donate = DonateUserDatas::where( 'pay_id', $pay_id )->first();
              $donate->status = 'complete';
              $donate->transaction_id = $transaction_id;
              $donate->save();
              return view( 'donate.donation_complete' );
              } else if( 'TXN_FAILURE' === $request['STATUS'] ){
              return view( 'donate.payment-failed' );
          }
      }
}
